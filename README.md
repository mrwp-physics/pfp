...
- Test and Set up git (no errors with these)
    git --version
...
- If you are like me, then ssh will not quite work yet - (https://stackoverflow.com/questions/15589682/ssh-connect-to-host-github-com-port-22-connection-timed-out "you need to follow the instructions here") to make a file config in your .ssh folder (not needed in WSL Debian!!)
...
cd projects
Grab the project from github (this will only work if you have sent me your ssh .pub key
This will make a new folder pfp with the project in
